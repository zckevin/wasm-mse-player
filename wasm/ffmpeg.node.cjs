...
var Module = typeof ffmpeg !== 'undefined' ? ffmpeg : {};
...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_add_js_callback')) {
        Object.defineProperty(Module['ready'], '_add_js_callback', { configurable: true, get: function() { abort('You are getting _add_js_callback on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_add_js_callback', { configurable: true, set: function() { abort('You are setting _add_js_callback on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
...
var wasmBinaryFile;
  wasmBinaryFile = 'ffmpeg.node.wasm';
...
var ASM_CONSTS = {
  ...
  var Asyncify={State:{Normal:0,Unwinding:1,Rewinding:2,Disabled:3},state:0,StackSize:300000,currData:null,handleSleepReturnValue:0,exportCallStack:[],callStackNameToId:{},callStackIdToName:{},callStackId:0,afterUnwind:null,asyncFinalizers:[],sleepCallbacks:[],getCallStackId:function(funcName) {
        ...
        var ASYNCIFY_IMPORTS = ["env.wait_readable","env.invoke_*","env.emscripten_sleep","env.emscripten_wget","env.emscripten_wget_data","env.emscripten_idb_load","env.emscripten_idb_store","env.emscripten_idb_delete","env.emscripten_idb_exists","env.emscripten_idb_load_blob","env.emscripten_idb_store_blob","env.SDL_Delay","env.emscripten_scan_registers","env.emscripten_lazy_load_code","env.emscripten_fiber_swap","wasi_snapshot_preview1.fd_sync","env.__wasi_fd_sync","env._emval_await"].map(function(x) {
          return x.split('.')[1];
        });
...
/** @type {function(...*):?} */
var _add_js_callback = Module["_add_js_callback"] = createExportWrapper("add_js_callback");
...
var _ff_h264_cabac_tables = Module['_ff_h264_cabac_tables'] = 258352;
